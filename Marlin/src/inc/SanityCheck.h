...
/**
 * Make sure HAVE_TMC2130/HAVE_TMC2208/HAVE_TMC2660 is warranted
 */
  ...
  #error "HAVE_TMC2660 requires at least one TMC2660 stepper to be set."
#endif
...
#if (ENABLED(X_IS_TMC2130) || ENABLED(X_IS_TMC2660)) && !PIN_EXISTS(X_CS)
  #error "X_CS_PIN is required for X_IS_TMC2130 and X_IS_TMC2660. Define X_CS_PIN in Configuration_adv.h."
#elif (ENABLED(X2_IS_TMC2130) || ENABLED(X2_IS_TMC2660)) && !PIN_EXISTS(X2_CS)
  #error "X2_CS_PIN is required for X2_IS_TMC2130 and X2_IS_TMC2660. Define X2_CS_PIN in Configuration_adv.h."
#elif (ENABLED(Y_IS_TMC2130) || ENABLED(Y_IS_TMC2660)) && !PIN_EXISTS(Y_CS)
  #error "Y_CS_PIN is required for Y_IS_TMC2130 and Y_IS_TMC2660. Define Y_CS_PIN in Configuration_adv.h."
#elif (ENABLED(Y2_IS_TMC2130) || ENABLED(Y2_IS_TMC2660)) && !PIN_EXISTS(Y2_CS)
  #error "Y2_CS_PIN is required for Y2_IS_TMC2130 and Y2_IS_TMC2660. Define Y2_CS_PIN in Configuration_adv.h."
#elif (ENABLED(Z_IS_TMC2130) || ENABLED(Z_IS_TMC2660)) && !PIN_EXISTS(Z_CS)
  #error "Z_CS_PIN is required for Z_IS_TMC2130 and Z_IS_TMC2660. Define Z_CS_PIN in Configuration_adv.h."
#elif (ENABLED(Z2_IS_TMC2130) || ENABLED(Z2_IS_TMC2660)) && !PIN_EXISTS(Z2_CS)
  #error "Z2_CS_PIN is required for Z2_IS_TMC2130 and Z2_IS_TMC2660. Define Z2_CS_PIN in Configuration_adv.h."
#elif (ENABLED(E0_IS_TMC2130) || ENABLED(E0_IS_TMC2660)) && !PIN_EXISTS(E0_CS)
  #error "E0_CS_PIN is required for E0_IS_TMC2130 and E0_IS_TMC2660. Define E0_CS_PIN in Configuration_adv.h."
#elif (ENABLED(E1_IS_TMC2130) || ENABLED(E1_IS_TMC2660)) && !PIN_EXISTS(E1_CS)
  #error "E1_CS_PIN is required for E1_IS_TMC2130 and E1_IS_TMC2660. Define E1_CS_PIN in Configuration_adv.h."
#elif (ENABLED(E2_IS_TMC2130) || ENABLED(E2_IS_TMC2660)) && !PIN_EXISTS(E2_CS)
  #error "E2_CS_PIN is required for E2_IS_TMC2130 and E2_IS_TMC2660. Define E2_CS_PIN in Configuration_adv.h."
#elif (ENABLED(E3_IS_TMC2130) || ENABLED(E3_IS_TMC2660)) && !PIN_EXISTS(E3_CS)
  #error "E3_CS_PIN is required for E3_IS_TMC2130 and E3_IS_TMC2660. Define E3_CS_PIN in Configuration_adv.h."
#elif (ENABLED(E4_IS_TMC2130) || ENABLED(E4_IS_TMC2660)) && !PIN_EXISTS(E4_CS)
  #error "E4_CS_PIN is required for E4_IS_TMC2130 and E4_IS_TMC2660. Define E4_CS_PIN in Configuration_adv.h."
#endif
  ...
  #elif ENABLED(X_IS_TMC2130) && X_HOME_DIR == -1 && DISABLED(X_MIN_ENDSTOP_INVERTING)
    #error "SENSORLESS_HOMING requires X_MIN_ENDSTOP_INVERTING when homing to X_MIN."
  #elif ENABLED(X_IS_TMC2130) && X_HOME_DIR ==  1 && DISABLED(X_MAX_ENDSTOP_INVERTING)
    #error "SENSORLESS_HOMING requires X_MAX_ENDSTOP_INVERTING when homing to X_MAX."
  #elif ENABLED(Y_IS_TMC2130) && Y_HOME_DIR == -1 && DISABLED(Y_MIN_ENDSTOP_INVERTING)
    #error "SENSORLESS_HOMING requires Y_MIN_ENDSTOP_INVERTING when homing to Y_MIN."
  #elif ENABLED(Y_IS_TMC2130) && Y_HOME_DIR ==  1 && DISABLED(Y_MAX_ENDSTOP_INVERTING)
