...
#define   HAS_TRINAMIC (ENABLED( HAVE_TMC2130) || ENABLED( HAVE_TMC2208) || ENABLED( HAVE_TMC2660) || ENABLED(IS_TRAMS))
#define  X_IS_TRINAMIC (ENABLED( X_IS_TMC2130) || ENABLED( X_IS_TMC2208) || ENABLED( X_IS_TMC2660) || ENABLED(IS_TRAMS))
#define  Y_IS_TRINAMIC (ENABLED( Y_IS_TMC2130) || ENABLED( Y_IS_TMC2208) || ENABLED( Y_IS_TMC2660) || ENABLED(IS_TRAMS))
#define  Z_IS_TRINAMIC (ENABLED( Z_IS_TMC2130) || ENABLED( Z_IS_TMC2208) || ENABLED( Z_IS_TMC2660) || ENABLED(IS_TRAMS))
#define X2_IS_TRINAMIC (ENABLED(X2_IS_TMC2130) || ENABLED(X2_IS_TMC2208) || ENABLED(X2_IS_TMC2660))
#define Y2_IS_TRINAMIC (ENABLED(Y2_IS_TMC2130) || ENABLED(Y2_IS_TMC2208) || ENABLED(Y2_IS_TMC2660))
#define Z2_IS_TRINAMIC (ENABLED(Z2_IS_TMC2130) || ENABLED(Z2_IS_TMC2208) || ENABLED(Z2_IS_TMC2660))
#define E0_IS_TRINAMIC (ENABLED(E0_IS_TMC2130) || ENABLED(E0_IS_TMC2208) || ENABLED(E0_IS_TMC2660) || ENABLED(IS_TRAMS))
#define E1_IS_TRINAMIC (ENABLED(E1_IS_TMC2130) || ENABLED(E1_IS_TMC2208) || ENABLED(E1_IS_TMC2660))
#define E2_IS_TRINAMIC (ENABLED(E2_IS_TMC2130) || ENABLED(E2_IS_TMC2208) || ENABLED(E2_IS_TMC2660))
#define E3_IS_TRINAMIC (ENABLED(E3_IS_TMC2130) || ENABLED(E3_IS_TMC2208) || ENABLED(E3_IS_TMC2660))
#define E4_IS_TRINAMIC (ENABLED(E4_IS_TMC2130) || ENABLED(E4_IS_TMC2208) || ENABLED(E4_IS_TMC2660))

#define    HAS_STEALTHCHOP (ENABLED( HAVE_TMC2130) || ENABLED( HAVE_TMC2208) || ENABLED(IS_TRAMS))
#define  X_HAS_STEALTHCHOP (ENABLED( X_IS_TMC2130) || ENABLED( X_IS_TMC2208) || ENABLED(IS_TRAMS))
#define  Y_HAS_STEALTHCHOP (ENABLED( Y_IS_TMC2130) || ENABLED( Y_IS_TMC2208) || ENABLED(IS_TRAMS))
#define  Z_HAS_STEALTHCHOP (ENABLED( Z_IS_TMC2130) || ENABLED( Z_IS_TMC2208) || ENABLED(IS_TRAMS))
#define X2_HAS_STEALTHCHOP (ENABLED(X2_IS_TMC2130) || ENABLED(X2_IS_TMC2208))
#define Y2_HAS_STEALTHCHOP (ENABLED(Y2_IS_TMC2130) || ENABLED(Y2_IS_TMC2208))
#define Z2_HAS_STEALTHCHOP (ENABLED(Z2_IS_TMC2130) || ENABLED(Z2_IS_TMC2208))
#define E0_HAS_STEALTHCHOP (ENABLED(E0_IS_TMC2130) || ENABLED(E0_IS_TMC2208) || ENABLED(IS_TRAMS))
#define E1_HAS_STEALTHCHOP (ENABLED(E1_IS_TMC2130) || ENABLED(E1_IS_TMC2208))
#define E2_HAS_STEALTHCHOP (ENABLED(E2_IS_TMC2130) || ENABLED(E2_IS_TMC2208))
#define E3_HAS_STEALTHCHOP (ENABLED(E3_IS_TMC2130) || ENABLED(E3_IS_TMC2208))
#define E4_HAS_STEALTHCHOP (ENABLED(E4_IS_TMC2130) || ENABLED(E4_IS_TMC2208))

#define    HAS_STALLGUARD (ENABLED( HAVE_TMC2130) || ENABLED( HAVE_TMC2660) || ENABLED(IS_TRAMS))
#define  X_HAS_STALLGUARD (ENABLED( X_IS_TMC2130) || ENABLED( X_IS_TMC2660) || ENABLED(IS_TRAMS))
#define  Y_HAS_STALLGUARD (ENABLED( Y_IS_TMC2130) || ENABLED( Y_IS_TMC2660) || ENABLED(IS_TRAMS))
#define  Z_HAS_STALLGUARD (ENABLED( Z_IS_TMC2130) || ENABLED( Z_IS_TMC2660) || ENABLED(IS_TRAMS))
#define X2_HAS_STALLGUARD (ENABLED(X2_IS_TMC2130) || ENABLED(X2_IS_TMC2660))
#define Y2_HAS_STALLGUARD (ENABLED(Y2_IS_TMC2130) || ENABLED(Y2_IS_TMC2660))
#define Z2_HAS_STALLGUARD (ENABLED(Z2_IS_TMC2130) || ENABLED(Z2_IS_TMC2660))
#define E0_HAS_STALLGUARD (ENABLED(E0_IS_TMC2130) || ENABLED(E0_IS_TMC2660) || ENABLED(IS_TRAMS))
#define E1_HAS_STALLGUARD (ENABLED(E1_IS_TMC2130) || ENABLED(E1_IS_TMC2660))
#define E2_HAS_STALLGUARD (ENABLED(E2_IS_TMC2130) || ENABLED(E2_IS_TMC2660))
#define E3_HAS_STALLGUARD (ENABLED(E3_IS_TMC2130) || ENABLED(E3_IS_TMC2660))
#define E4_HAS_STALLGUARD (ENABLED(E4_IS_TMC2130) || ENABLED(E4_IS_TMC2660))
  ...
  #endif
  #define X_SENSORLESS (X_HAS_STALLGUARD && defined(X_HOMING_SENSITIVITY))
  #define Y_SENSORLESS (Y_HAS_STALLGUARD && defined(Y_HOMING_SENSITIVITY))
  #define Z_SENSORLESS (Z_HAS_STALLGUARD && defined(Z_HOMING_SENSITIVITY))
#endif
