...
#define HAS_HYBRID_THRS (ENABLED(HAVE_TMC2130) || ENABLED(HAVE_TMC2208) || ENABLED(IS_TRAMS))
#define  X_HAS_HYBRID_THRS (ENABLED( X_IS_TMC2130) || ENABLED( X_IS_TMC2208) || ENABLED(IS_TRAMS))
#define X2_HAS_HYBRID_THRS (ENABLED(X2_IS_TMC2130) || ENABLED(X2_IS_TMC2208))
#define  Y_HAS_HYBRID_THRS (ENABLED( Y_IS_TMC2130) || ENABLED( Y_IS_TMC2208) || ENABLED(IS_TRAMS))
#define Y2_HAS_HYBRID_THRS (ENABLED(Y2_IS_TMC2130) || ENABLED(Y2_IS_TMC2208))
#define  Z_HAS_HYBRID_THRS (ENABLED( Z_IS_TMC2130) || ENABLED( Z_IS_TMC2208) || ENABLED(IS_TRAMS))
#define Z2_HAS_HYBRID_THRS (ENABLED(Z2_IS_TMC2130) || ENABLED(Z2_IS_TMC2208))
#define E0_HAS_HYBRID_THRS (ENABLED(E0_IS_TMC2130) || ENABLED(E0_IS_TMC2208) || ENABLED(IS_TRAMS))
#define E1_HAS_HYBRID_THRS (ENABLED(E1_IS_TMC2130) || ENABLED(E1_IS_TMC2208))
#define E2_HAS_HYBRID_THRS (ENABLED(E2_IS_TMC2130) || ENABLED(E2_IS_TMC2208))
#define E3_HAS_HYBRID_THRS (ENABLED(E3_IS_TMC2130) || ENABLED(E3_IS_TMC2208))
#define E4_HAS_HYBRID_THRS (ENABLED(E4_IS_TMC2130) || ENABLED(E4_IS_TMC2208))
