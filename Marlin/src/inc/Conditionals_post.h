...
#define HAS_TRINAMIC (ENABLED(HAVE_TMC2130) || ENABLED(HAVE_TMC2208) || ENABLED(HAVE_TMC5160) || ENABLED(IS_TRAMS))
#define  X_IS_TRINAMIC (ENABLED( X_IS_TMC2130) || ENABLED( X_IS_TMC2208) || ENABLED( X_IS_TMC5160) || ENABLED(IS_TRAMS))
#define X2_IS_TRINAMIC (ENABLED(X2_IS_TMC2130) || ENABLED(X2_IS_TMC2208) || ENABLED(X2_IS_TMC5160))
#define  Y_IS_TRINAMIC (ENABLED( Y_IS_TMC2130) || ENABLED( Y_IS_TMC2208) || ENABLED( Y_IS_TMC5160) || ENABLED(IS_TRAMS))
#define Y2_IS_TRINAMIC (ENABLED(Y2_IS_TMC2130) || ENABLED(Y2_IS_TMC2208) || ENABLED(Y2_IS_TMC5160))
#define  Z_IS_TRINAMIC (ENABLED( Z_IS_TMC2130) || ENABLED( Z_IS_TMC2208) || ENABLED( Z_IS_TMC5160) || ENABLED(IS_TRAMS))
#define Z2_IS_TRINAMIC (ENABLED(Z2_IS_TMC2130) || ENABLED(Z2_IS_TMC2208) || ENABLED(Z2_IS_TMC5160))
#define E0_IS_TRINAMIC (ENABLED(E0_IS_TMC2130) || ENABLED(E0_IS_TMC2208) || ENABLED(E0_IS_TMC5160) || ENABLED(IS_TRAMS))
#define E1_IS_TRINAMIC (ENABLED(E1_IS_TMC2130) || ENABLED(E1_IS_TMC2208) || ENABLED(E1_IS_TMC5160))
#define E2_IS_TRINAMIC (ENABLED(E2_IS_TMC2130) || ENABLED(E2_IS_TMC2208) || ENABLED(E2_IS_TMC5160))
#define E3_IS_TRINAMIC (ENABLED(E3_IS_TMC2130) || ENABLED(E3_IS_TMC2208) || ENABLED(E3_IS_TMC5160))
#define E4_IS_TRINAMIC (ENABLED(E4_IS_TMC2130) || ENABLED(E4_IS_TMC2208) || ENABLED(E4_IS_TMC5160))
  ...
  #endif
  #define X_SENSORLESS ((ENABLED(X_IS_TMC2130) || ENABLED(X_IS_TMC5160)) && defined(X_HOMING_SENSITIVITY))
  #define Y_SENSORLESS ((ENABLED(Y_IS_TMC2130) || ENABLED(Y_IS_TMC5160)) && defined(Y_HOMING_SENSITIVITY))
  #define Z_SENSORLESS ((ENABLED(Z_IS_TMC2130) || ENABLED(Z_IS_TMC5160)) && defined(Z_HOMING_SENSITIVITY))
#endif
